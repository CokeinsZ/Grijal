...
public class SpajingLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "T__14", "T__15", "CLASE", 
			"FUNCION", "RETORNAR", "PREGUNTA", "SINO", "MIENTRAS", "MOSTRAR", "FIN", 
			"FIN_CONDICIONAL", "ENTERO_TIPO", "REAL_TIPO", "LOGICO_TIPO", "TEXTO_TIPO", 
			"AND", "OR", "NOT", "ASIGNACION", "BOOLEANO", "ENTERO", "REAL", "CADENA", 
			"ID", "WS", "COMENTARIO"
		};
	}
	...
	public SpajingLexer(CharStream input) {
		super(input);
